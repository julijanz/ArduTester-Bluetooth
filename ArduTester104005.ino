...
#define HC05         /* bluetooth module hc-05 */

//#define LCD1602
//#define LCD_I2C
#define NOK5110      /* when using HC05, you must define NOK5110 */ 
//#define OLED096
//#define OLED_I2C
...
#ifdef NOK5110
#include <SPI.h>
#include <Adafruit_GFX.h> //Adafruit GFX Library by Adafruit v. 1.11.9
#include <Adafruit_PCD8544.h>  //Adafruit PCD85444 Nokia 5110 LCD library by Adafruit v. 2.0.3
#endif
...
#define R_L_VAL 6680        // this will be define a 668 Ohm
//#define R_H_VAL 47000     // standard value 470000 Ohm, multiplied by 10, divided by 100 
#define R_H_VAL 47500       // this will be define a 473000 Ohm, divided by 100 
...
void setup()
{
	...
	#ifdef HC05
	Serial.println("Tester 1.08.005");
	...
	*/
	...
	if (adc.lp_otr < 977)
	{
		...
		if (adc.lp1 > 3422)
		{
			...
			#ifdef LONG_HFE
			trans.hfe[PartReady] = ((unsigned int) tmp16 * (unsigned long) (((unsigned long) R_H_VAL * 100) / (unsigned int) RR680MI)) / (unsigned int) adc.tp2;
			#else
		...
		if (adc.tp1 < 10)
		{
			...
			#ifdef LONG_HFE
			c_hfe = ((unsigned long) adc.lp1 * (unsigned long) (((unsigned long) R_H_VAL * 100) / (unsigned int) RR680MI)) / (unsigned int) adc.tp1;
			#else
		...
		if (adc.hp1 < 1600)
		{
			...
			#ifdef LONG_HFE
			trans.hfe[PartReady] = ((unsigned int) tmp16 * (unsigned long) (((unsigned long) R_H_VAL * 100) / (unsigned int) RR680PL)) / (unsigned int) adc.tp2;
			#else
