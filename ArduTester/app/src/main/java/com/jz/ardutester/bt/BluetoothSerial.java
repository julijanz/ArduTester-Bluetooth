 ...
 * BluetoothSerial creates a Bluetooth serial port using the Serial Port Profile (SPP) and manages its lifecycle.
 */
    ...
    public void setup()
    {
        if (checkBluetooth())
        {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M)
            {
                ...
                if (ActivityCompat.checkSelfPermission(ApplicationArduTester.getContext(), Manifest.permission.BLUETOOTH_CONNECT) != PackageManager.PERMISSION_GRANTED)
                {
